insert into author(id, first_name, last_name, email_address) values (1, "stella", "chieh","stella@gmail.com");
insert into author(id, first_name, last_name, email_address) values (2, "hank", "lin", "hank@gmail.com");
